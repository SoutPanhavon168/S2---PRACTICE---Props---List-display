...
function App() {
  return (
    <div id="app">
      ...
      <User firstName={vinhData.firstName} lastName={vinhData.lastName} title={userData.title}/> {/* This line needs some changes*/}
      <User firstName={userData.firstName} /> {/* This line needs some changes*/}
    </div>
  );
}
